...
The Prediction Model was trained on a combined randomly selected 10% sample from each corpus, totaling approximately 55  MB due to deployment server restriction. 
...
- The App is deployed shinyapps.io: [ShinyApp: Most Probable Next Word(s) Predictor](https://aberra.shinyapps.io/snidngy/)
